...
<br>
In our view file, it may contain a links or scripts like  

```html
<link href="/some_cssFile.css">
<!-- or -->
<script src="some_js_file.js"></script>
```

so the browser will make a new GET request asking for those files. then we have to make a handler in server side to send this files to the browser.
<br>
